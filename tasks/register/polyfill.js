...
module.exports = function(grunt) {
  grunt.registerTask('polyfill:prod', 'Add the polyfill file to the top of the list of files to concatenate', ()=>{
    // Use our custom lightweight regenerator polyfill directly from assets
    const path = require('path');
    const polyfillPath = path.resolve('assets/js/regenerator-polyfill.js');
    grunt.config.set('concat.js.src', [polyfillPath].concat(grunt.config.get('concat.js.src')));
  });
